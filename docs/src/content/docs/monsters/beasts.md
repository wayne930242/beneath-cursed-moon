...
`黏網陷阱`：人蛛巢穴布滿巨網且難以察覺。角色穿越巢穴時需進行「追獵」動作；結果 `6 以下` 會被困網中且陷入無助。可用「浴血奮戰」嘗試脫困或救人：`6 以下` 代表陷得更深（甚至救援者也被困），`7 以上` 則成功脫困。
...
`黏網陷阱`：巨蛛巢穴常布滿難辨巨網。角色穿越時需進行「追獵」動作；`6 以下` 會被困並無助。可用「浴血奮戰」嘗試脫困：`6 以下` 會陷得更深，`7 以上` 成功脫困。
